...
for.cond2:                                        ; preds = %for.inc16, %for.end
  %3 = load i32, i32* %i1, align 4, !dbg !54
  %cmp3 = icmp slt i32 %3, 15, !dbg !56
  br i1 %cmp3, label %for.body4, label %for.end18, !dbg !57

for.body4:                                        ; preds = %for.cond2
  %4 = load i32, i32* %i1, align 4, !dbg !58
  %sub = sub nsw i32 %4, 1, !dbg !60
  %idxprom5 = sext i32 %sub to i64, !dbg !61
  %arrayidx6 = getelementptr inbounds [16 x i32], [16 x i32]* %input, i64 0, i64 %idxprom5, !dbg !61
  %5 = load i32, i32* %arrayidx6, align 4, !dbg !61
  %6 = load i32, i32* %i1, align 4, !dbg !62
  %idxprom7 = sext i32 %6 to i64, !dbg !63
  %arrayidx8 = getelementptr inbounds [16 x i32], [16 x i32]* %input, i64 0, i64 %idxprom7, !dbg !63
  %7 = load i32, i32* %arrayidx8, align 4, !dbg !63
  %add = add nsw i32 %5, %7, !dbg !64
  %8 = load i32, i32* %i1, align 4, !dbg !65
  %add9 = add nsw i32 %8, 1, !dbg !66
  ...
  %9 = load i32, i32* %arrayidx11, align 4, !dbg !67
  %add12 = add nsw i32 %add, %9, !dbg !68
  %10 = load i32, i32* %i1, align 4, !dbg !69
  %sub13 = sub nsw i32 %10, 1, !dbg !70
...
for.inc16:                                        ; preds = %for.body4
  %11 = load i32, i32* %i1, align 4, !dbg !74
  %inc17 = add nsw i32 %11, 1, !dbg !74
